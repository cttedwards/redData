...
usethis::use_data(reg_dat_forest)
usethis::use_data(dat_forest)
```
...
usethis::use_data(reg_dat_savannah)
usethis::use_data(dat_savannah)
```
...
usethis::use_data(reg_dat_global)
usethis::use_data(dat_global)
```
